...
function initializeVariables() {
    ...
    document.getElementById('timer-body').style.backgroundColor = '';
}
...
if (minutes === 0 && seconds === 0) {
    document.getElementById('timer-body').style.backgroundColor = 'red';
} else if (['standardSpeech', 'tableTopicsEvaluation', 'generalEvaluatorReport'].includes(role)) {
    if (minutes === 2 && seconds === 0) {
        document.getElementById('timer-body').style.backgroundColor = 'green';
    } else if (minutes === 1 && seconds === 0) {
        document.getElementById('timer-body').style.backgroundColor = 'yellow';
    }
} else if (role === 'custom') {
